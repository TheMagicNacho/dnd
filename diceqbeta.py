"""
Remember to install qiskit:  conda install quiskit
also remember to turn on your environment: conda activate q
If the dependenceies and the environment are not pre installed the program will not work.
"""
...
#IBMQ.save_account('fff5ac420320c140ae530a02203cc4917906036fd6065ebbf7bbfd985fe5bf307827bef22a9b0fe6da22d74d8fe85c3c85cf9f2539784de58685443d300e94a9')
print()
print("IBM Q version:", qiskit.__version__ )
def main():
  while True:
    prompt_user()
